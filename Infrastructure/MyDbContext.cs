    ...
    public class MyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Staff>().HasData(
               new { Id = 1, CitizenCode="04321842241", FullName = "Nguyen Thi Kim Tuyen",Birthday= new DateTime(2001, 2, 1), Phone = "0943357323", Address = "5/6 Nguyen Cong Tru Str, Hue", RoleId = 1, Email = "admin@abc.com", Password = "admin@2022", CreatedDate = new DateTime(2022, 1, 17) },
               new { Id = 2, CitizenCode = "04242144124", FullName = "Nguyen Van Tai", Birthday = new DateTime(1989, 2, 1), Phone = "0943357329", Address = "5/10 Nguyen Hue Str, Hue", RoleId = 2, Email = "tai@gmail.com", Password = "admin@2022", CreatedDate = new DateTime(2023, 1, 1) }
               );
